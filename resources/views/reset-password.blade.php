...
<body class="bg-[#e0f0ff] flex items-center justify-center min-h-screen">
    ...
    <div
        ...
        <div class="flex-1 bg-[#cce5ff] p-8 md:p-12 flex flex-col justify-center">
            <h2 class="text-center text-3xl md:text-4xl font-bold text-[#102263] mb-6">Reset Password</h2>
            ...
            <form action="/reset-password" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="password" class="block text-[#102263] font-semibold mb-2">Password Baru</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-[#102263] font-semibold mb-2">Konfirmasi
                        Password</label>
                    <input type="password" id="password_confirmation" name="password_confirmation"
                        placeholder="Enter Password" required oninvalid="this.setCustomValidity('Password harus diisi')"
        ...
        <div class="hidden md:flex flex-1 bg-[#102263] text-white p-8 md:p-12  flex-col justify-center relative">
            <h2 class="text-[#cce5ff] font-bold text-4xl md:text-5xl leading-tight mb-2">
