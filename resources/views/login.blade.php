...
<body class="bg-[#e0f0ff] m-0 p-0 flex items-center justify-center min-h-screen">
    ...
    <div
        ...
        <div class="bg-[#cce5ff] flex flex-col justify-center px-8 lg:px-12 py-10 lg:py-0 w-full lg:w-1/2">
            <h2 class="text-[#102263] font-bold text-3xl mb-8 text-center ">Login</h2>
            ...
            <form action="/login" method="post" class="space-y-5">
                @csrf
                <div>
                    <label for="nim" class="block text-[#102263] font-semibold mb-1">NIM</label>
                ...
                <div>
                    <label for="password" class="block text-[#102263] font-semibold mb-1">Password</label>
                ...
                <div class="text-sm mt-2">
                    <a href="/forgot-password" class="text-[#102263] hover:underline">Lupa Sandi?</a>
                </div>
                ...
                <a href="{{ url('/auth/google') }}"
                    class="w-full border border-gray-300 bg-white text-gray-700 rounded-md py-2 flex items-center justify-center font-medium hover:bg-gray-50 transition duration-200">
                ...
                <div class="text-center text-sm mt-4">
                    <a href="/register" class="text-gray-700 hover:underline">Belum punya akun?</a>
                </div>
            </form>
        </div>
